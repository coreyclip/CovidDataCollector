...
try:
    ...
    try:
        ...
        driver.find_element(By.CSS_SELECTOR, "li:nth-child(6) span").click()
        wait_for("#DataTables_Table_0_length > label:nth-child(1) > select:nth-child(1)", "css")
    driver.find_element(By.CSS_SELECTOR, "#DataTables_Table_0_length > label:nth-child(1) > select:nth-child(1)").click()
    dropdown = driver.find_element(By.CSS_SELECTOR, "#DataTables_Table_0_length > label:nth-child(1) > select:nth-child(1)")
    time.sleep(10)
    try:
        ...
        pass
    time.sleep(2)
    driver.find_element(By.CSS_SELECTOR, "#DataTables_Table_0_length option:nth-child(3)").click()
    time.sleep(5)
